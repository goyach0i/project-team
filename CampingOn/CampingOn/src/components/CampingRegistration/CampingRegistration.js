    ...
    <div className="CampingRegistration">
      ...
      <from>
        ...
        <div className="registerCampingBox">
          <label className="campingRegistrationName">캠핑장 이름</label>
          <input onChange={oncampingSitenameHandler} name="campsiteName" className="registrationInput" type="text"></input>
          <div>
            <div className="addressWrap">
              <label className="campingRegistrationName">주소</label>
            ...
            <label className="campingRegistrationName"></label>
            ...
            <div>
              <label className="campingRegistrationName">지역</label>
          ...
          <div>
            <label className="campingRegistrationNameLeft">옵션선택</label>
            <div className="rowFlexBoxTablet">
              <div className="rowFlexBoxLeftRegistration">
