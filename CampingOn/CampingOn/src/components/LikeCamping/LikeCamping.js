...
const LikeCamping = () => {
  ...
  const getUserPick = () => {
    axios
      .get("/pick/" + localStorage.getItem("userId"), {})
      .then((response) => {
        ...
        {data.map((d, i) => {
          return (
            <div className="contentsLikeCamping" key={i}>
              ...
              <img src={d.campsite.topImage}></img>
              </div>
              <div className="contentsTextLikeCamping">
                <div className="contentsRowFlexLikeCamping">
                  ...
                  ></img>
                  <h2 className="contentsNameLikeCamping">
                    {d.campsite.campsiteName}
                  </h2>
                </div>
                <p className="contentsInfoLikeCamping">
                  {d.campsite.campsiteIntroduction}
                </p>
                <p className="contentsInfoLikeCamping">
                  대표옵션 :{d.campsite.barbecue ? "바베큐 장, " : null}
